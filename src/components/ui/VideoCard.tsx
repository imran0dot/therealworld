...
const VideoCard: React.FC<VideoCardType> = ({ cardDetails }) => {
    ...
    return (
        <div className='p-[2px] group relative' style={{ boxShadow: '0 0 40px #010a13' }}>

            <div className='relative group bg-[#111C22] bg-opacity-20 rounded-md'>
            ...
            <div className='absolute w-full'>
                ...
                <div className='min-h-60 gap-4 grid grid-flow-row p-4'>
