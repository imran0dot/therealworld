...
const Pricing: React.FC = () => {
    return (
        <div className='min-h-screen bg-center bg-cover py-28' style={{ backgroundImage: `url(${pricingBG})` }}>
            <ContainerSmall>
                ...
                <div className='grid md:grid-cols-2 gap-5 my-10 mx-auto'>
                    {/* pricing one  */}
                    <div className='p-3 text-center backdrop-blur-sm py-10  shadow-sm'>
                        <div className='relative flex flex-col justify-center items-center px-5'>
                            <div className='flex flex-col gap-10 min-h-[650px]'>
                                {/* icon  */}
                            ...
                            {/* button  */}
                            <div className='bg-[#212833] w-full p-5 text-lg m-3'>
                                <span>Remain an Employee</span>
                            </div>
                        </div>
                    </div>

                    {/* pricing two  */}
                    <div className='p-3 relative group hover:-translate-y-5 transition-all duration-500'>
                        <div className='relative flex flex-col bg-[#19202E] justify-center items-center text-center backdrop-blur-md py-10 border-[1px] border-slate-500 border-opacity-30 shadow-sm   group overflow-hidden z-20'>
                            <div className='flex flex-col gap-10 min-h-[650px] '>
                                {/* icon  */}
                                <div className='flex  flex-col justify-center items-center gap-2'>
                                    <img src={handSVG} alt="" />
                        ...
                        <div className='absolute bg-gradient-to-b from-transparent via-transparent to-secondary-white from-40% top-0 bottom-0 left-0 right-0 z-10 opacity-0 group-hover:opacity-30 transition-all duration-300'></div>
                    </div>
                </div>
