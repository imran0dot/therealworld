            ...
            <div className='flex flex-col items-end justify-center w-full'>
                <div className='w-7/12 pl-20'>
                    ...
                    <div className='flex flex-col gap-10'>
                        ...
                        <strong className='text-white text-xl'>What have you been doing to prepare?</strong>
